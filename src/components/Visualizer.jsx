    ...
    return (
        <div className="relative md:max-w-[95vw] container m-auto">
           ...
           <div className="flex flex-col-reverse md:flex-row h-[80vh] md:h-[70vh] md:mt-1 md:mb-3 lg:mt-4 gap-2">
                ...
                <div className="w-full shadow-[0px_0px_10px_inset] md:shadow-[0px_0px_20px_inset] shadow-pink-700 md:h-full border-t-2 border-b-2 border-pink-900 rounded-2xl p-3 md:p-4">
...
<div className={`lg:block hidden ${raceMode?"md:hidden":""} md:max-w-40 lg:max-w-60 h-[99%] rounded-2xl border-2 overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-800 [&::-webkit-scrollbar-thumb]:bg-green-500 [&::-webkit-scrollbar-thumb]:rounded-full`}>
